...
void leggiCarte(int cnValoriMano[], int cnSemiMano[]);
void decretaPunteggio(int cnValoriMano[], int cnSemiMano[]);
...
int main(void){
    ...
    while(true){
        leggiCarte(cnValoriMano, cnSemiMano);
        decretaPunteggio(cnValoriMano, cnSemiMano);
        stampaPunteggio();
    }
